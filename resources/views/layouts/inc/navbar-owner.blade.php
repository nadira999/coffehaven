    ...
    <ul class="navbar-nav ml-auto">
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                ...
                <img class="img-profile rounded-circle" src="{{ asset('images/profil.jpeg') }}" width="35" height="35" style="object-fit: cover;">
                <span class="ml-2 d-none d-lg-inline text-gray-600 small">{{ Auth::guard('owner')->user()->nama }}</span>
            </a>
